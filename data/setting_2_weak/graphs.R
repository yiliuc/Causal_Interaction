...
model_names_common <- c("Default LOM", "CLOM(X5678)", "DR")
mslom_name_5678         <- "MSLOM(X5678)"
...
bias_mslom1 <- compute_b3_bias(mslom_name_5678, results_control_all, population_truth) %>%
  rename(MSLOM_X5678_C = !!mslom_name_5678)

bias_mslom2 <- compute_b3_bias(mslom_name_5678, results_both_all,    population_truth) %>%
  rename(MSLOM_X5678_A = !!mslom_name_5678)
...
bias_long$Model[bias_long$Model == "MSLOM_X5678_C"] <- "MSLOM(X5678)_C"
bias_long$Model[bias_long$Model == "MSLOM_X5678_A"] <- "MSLOM(X5678)_A"
...
#         legend.text  = element_text(size = 16),   # entry text
#         legend.title = element_text(size = 16),   # title text
